...
from routes.application_history_log import router as application_history_log_router
...
app.include_router(router=application_history_log_router, prefix="/api/log")
