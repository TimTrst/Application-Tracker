        ...
        with sqlite3.connect(DATABASE_NAME) as conn:
            ...
            states = [
                ...
                (
                    ...
                    get_phase_id_by_name(conn, ("Interviewing",)),
                ),
            ...
            #     (
            #         "Test Firma",
            #         "Test Job: Entwickler (m,w,d)",
            #         "",
            #         get_status_id_by_name(conn, ("Applied",)),
            #         "2026-01-01",
            #         "2026-01-02",
            #     ),
            #     (
            #         "Test Firma2",
            #         "Test Job: Fullstack-Entwickler (m,w,d)",
            #         "",
            #         get_status_id_by_name(conn, ("Job Interview",)),
            #         "2026-02-10",
            #         "2026-03-21",
            #     ),
            #     (
            #         "Test Firma3",
            #         "Test Job: Java-Entwickler (m,w,d)",
            #         "",
            #         get_status_id_by_name(conn, ("Rejected",)),
            #         "2026-03-11",
            #         "2026-05-09",
            #     ),
            # ]
